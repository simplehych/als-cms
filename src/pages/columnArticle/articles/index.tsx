...
import { Button, Card, Col, Form, List, Row, Select, Tabs, Tag } from 'antd';
...
const Articles = (topProps) => {
  ...
  const renderTabBar = (props, DefaultTabBar) => (
    <Sticky topOffset={280} relative={true}>
      {({ style }) => (
  ...
  return (
    <StickyContainer style={{overflow: "auto", height: "100%"}}>
      <Tabs defaultActiveKey="1" tabPosition='top' renderTabBar={renderTabBar}>
